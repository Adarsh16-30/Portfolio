// Add or modify certificates here
export const certificatesData = [
  {
    title: "IBM Full Stack Software Developer",
    issuer: "IBM - Coursera",
    date: "2024",
    description: "Completed a comprehensive program covering front-end and back-end development, cloud computing, DevOps, and deployment. Gained hands-on experience building and deploying full-stack web applications.",
    skills: ["HTML", "CSS", "JavaScript", "React", "Node.js", "Express", "Python", "Django", "REST APIs", "Git/GitHub", "Docker", "IBM Cloud", "AWS"],
    certificateUrl: "https://drive.google.com/drive/folders/1_J6b9OxMDBUMmO6RKrivexdn6jN9VDRf?usp=sharing",
    icon: "Award",
  ...
  },
  {
    ...
    date: "2024",
    description: "Completed an in-depth course focused on core Java programming concepts, object-oriented programming (OOP), and application development. Gained hands-on experience in Java syntax, data structures, algorithms, exception handling, file I/O, multithreading, and building modular, scalable applications.",
    skills: ["Java", "OOP", "Data Structures", "Algorithms", "Multithreading"],
    certificateUrl: "https://drive.google.com/drive/folders/1DR0Drcr5lcak-8QJqeSaYgjzyqrWChGq?usp=sharing",
    icon: "Code",
