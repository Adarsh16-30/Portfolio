...
export const ABOUT_TEXT = {
  intro: `<span class='line-header'>About Adarsh Tripathi</span> Full Stack Developer & ML Engineer based in Vellore, India. I build scalable systems, ship production code, and explore emerging tech.`,
  whatIDo: `<span class='line-section'>WHAT I DO</span> I turn complexity into clarity. From RAG systems for 40,000+ students to zero-trust SOCs and deep learning pipelines, my work sits at the intersection of engineering craft, systems thinking, and research. At every stage I ask: <span class='line-accent'>"Does this remove friction?"</span>`,
  education: `<span class='line-section'>EDUCATION</span> • VIT, B.Tech CSE (2023–2027), CGPA: 8.96 • DAV Public School, Delhi — XII: 94%, X: 88%`,
  skills: `<span class='line-section'>SKILLS</span> Python, Java, C, C++, JS, TS, React, Node.js, Flask, Django, MySQL, MongoDB, REST APIs, Docker, K8s, TensorFlow, Git, Linux`,
  projects: `<span class='line-section'>PROJECTS</span> College RAG System • Zero-Trust SOC Platform • WaferMap Pattern Intelligence • Shiksha Sahayak • CLI Suite`,
  research: `<span class='line-section'>RESEARCH & PUBLICATIONS</span> Patent: Early Crop Disease Detection (VIT, 2026) • Paper: Quantum-Enhanced Crop Disease Detection`,
  hackathons: `<span class='line-section'>HACKATHONS & COMPETITIONS</span> Deloitte HackSplosion 2026 • SIH 2025 • BrAINWARS 2026 • JPMC Code for Good 2026`,
  certs: `<span class='line-section'>CERTIFICATIONS</span> IBM Full Stack • Amazon Java • Stanford ML • Oracle GenAI • Google Cybersecurity`,
  experience: `<span class='line-section'>EXPERIENCE</span> IEEE EMBS, VIT (2024): Organized technical workshops on biomedical engineering and healthcare tech.`,
  beyond: `<span class='line-section'>BEYOND THE SCREEN</span> Mentoring, open source, systems thinking, cycling, photography. <span class='line-muted'><i>Still there? Try /work to see what I've built...</i></span>`
};
